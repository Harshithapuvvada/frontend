...
function MyApp() {
  const [products] = useState([
    ...
    { id: 10, name: 'Brownrice', image: Brownrice, price: 400 },
    ...
    { id: 8, name: 'pulses', image: Pulses, price: 120 },
    { id: 10, name: 'Freedomoil', image: Freedomoil, price: 299 },
    { id: 11, name: 'Shampoo', image: Shampoo, price: 199 },
    { id: 11, name: 'soaps', image: soaps, price: 194 },
    { id: 11, name: 'Sugar', image: Sugar, price: 99 },
    { id: 11, name: 'oil', image: oil, price: 40 },
    { id: 11, name: 'facewash', image: facewash, price: 60 },
